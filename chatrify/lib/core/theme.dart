    ...
    return ThemeData(
        ...
        textTheme: TextTheme(
          titleMedium: GoogleFonts.alegreyaSans(
              fontSize: FontSizes.small, color: Colors.white),
          titleLarge: GoogleFonts.alegreyaSans(
              fontSize: FontSizes.large, color: Colors.white),
          bodySmall: GoogleFonts.alegreyaSans(
              fontSize: FontSizes.standardUp, color: Colors.white),
          bodyMedium: GoogleFonts.alegreyaSans(
              fontSize: FontSizes.standard, color: Colors.white),
